	...
	public static void main(String[] args) {
		...
		case 25:
			if (temp == 2) {
				...
				System.out.print(" 딸기라떼는 없는 메뉴입니다.");
				break;
			}
		...
		case 26:
			if (temp == 2) {
				...
				System.out.print(" 오레오초코라떼는 없는 메뉴입니다.");
				break;
			}
		...
		case 36:
			if (temp == 2) {
				...
				System.out.print(" 복숭아 아이스티는 없는 메뉴입니다.");				
				break;
			}
		...
		case 37:
			if (temp == 2) {
				...
				System.out.print(" 체리콕은 없는 메뉴입니다.");
				break;
			}
		...
		case 38:
			if (temp == 2) {
				...
				System.out.print(" 레몬에이드는 없는 메뉴입니다.");				
				break;
			}
		...
		case 39:
			if (temp == 2) {
				...
				System.out.print(" 블루레몬에이드는 없는 메뉴입니다.");				
				break;
			}
		...
		case 40:
			if (temp == 2) {
				...
				System.out.print(" 자몽에이드는 없는 메뉴입니다.");				
				break;
			}
		...
		case 41:
			if (temp == 2) {
				...
				System.out.print(" 청포도에이드는 없는 메뉴입니다.");				
				break;
			}
		...
		case 42:
			if (temp == 2) {
				...
				System.out.print(" 메가에이드는 없는 메뉴입니다.");				
				break;
			}
		...
		case 43:
			if (temp == 2) {
				...
				System.out.print(" 라임모히또는 없는 메뉴입니다.");				
				break;
			}
		...
		case 44:
			if (temp == 2) {
				...
				System.out.print(" 자몽모히또는 없는 메뉴입니다.");				
				break;
			}
		...
		case 45:
			if (temp == 2) {
				...
				System.out.print(" 청포도모히또는 없는 메뉴입니다.");				
				break;
			}
		...
		case 46:
			if (temp == 2) {
				...
				System.out.print(" 매직에이드 (블루)는 없는 메뉴입니다.");				
				break;
			}
		...
		case 47:
			if (temp == 2) {
				...
				System.out.print(" 매직에이드 (핑크)는 없는 메뉴입니다.");				
				break;
			}
		...
		case 48:
			if (temp == 2) {
				...
				System.out.print(" 플레인요거트스무디는 없는 메뉴입니다.");				
				break;
			}
		...
		case 49:
			if (temp == 2) {
				...
				System.out.print(" 망고요거트스무디는 없는 메뉴입니다.");				
				break;
			}
		...
		case 50:
			if (temp == 2) {
				...
				System.out.print(" 딸기요거트스무디는 없는 메뉴입니다.");				
				break;
			}
		...
		case 51:
			if (temp == 2) {
				...
				System.out.print(" 스트로베리치즈홀릭은 없는 메뉴입니다.");				
				break;
			}
		...
		case 52:
			if (temp == 2) {
				...
				System.out.print(" 쿠키프라페는 없는 메뉴입니다.");				
				break;
			}
		...
		case 53:
			if (temp == 2) {
				...
				System.out.print(" 민트프라페는 없는 메뉴입니다.");				
				break;
			}
		...
		case 54:
			if (temp == 2) {
				...
				System.out.print(" 리얼초코프라페는 없는 메뉴입니다.");				
				break;
			}
		...
		case 55:
			if (temp == 2) {
				...
				System.out.print(" 녹차프라페는 없는 메뉴입니다.");				
				break;
			}
		...
		case 56:
			if (temp == 2) {
				...
				System.out.print(" 커피프라페는 없는 메뉴입니다.");				
				break;
			}
		...
		case 57:
			if (temp == 2) {
				...
				System.out.print(" 딸기쿠키프라페는 없는 메뉴입니다.");				
				break;
			}
		...
		case 58:
			if (temp == 2) {
				...
				System.out.print(" 유니콘프라페는 없는 메뉴입니다.");				
				break;
			}
		...
		case 59:
			if (temp == 2) {
				...
				System.out.print(" 플레인퐁크러쉬는 없는 메뉴입니다.");				
				break;
			}
		...
		case 60:
			if (temp == 2) {
				...
				System.out.print(" 바나나퐁크러쉬는 없는 메뉴입니다.");				
				break;
			}
		...
		case 61:
			if (temp == 2) {
				...
				System.out.print(" 딸기퐁크러쉬는 없는 메뉴입니다.");				
				break;
			}
		...
		case 62:
			if (temp == 2) {
				...
				System.out.print(" 플레인허니퐁크러쉬는 없는 메뉴입니다.");				
				break;
			}
		...
		case 63:
			if (temp == 2) {
				...
				System.out.print(" 슈크림허니퐁크러쉬는 없는 메뉴입니다.");				
				break;
			}
		...
		case 64:
			if (temp == 2) {
				...
				System.out.print(" 초코허니퐁크러쉬는 없는 메뉴입니다.");				
				break;
			}
		...
		case 65:
			if (temp == 2) {
				...
				System.out.print(" 오곡바나나주스는 없는 메뉴입니다.");				
				break;
			}
		...
		case 66:
			if (temp == 2) {
				...
				System.out.print(" 초코바나나주스는 없는 메뉴입니다.");				
				break;
			}
		...
		case 67:
			if (temp == 2) {
				...
				System.out.print(" 딸기바나나주스는 없는 메뉴입니다.");				
				break;
			}
		...
		case 68:
			if (temp == 2) {
				...
				System.out.print(" 딸기주스는 없는 메뉴입니다.");				
				break;
			}
		...
		case 69:
			if (temp == 2) {
				...
				System.out.print(" 흑당버블라떼는 없는 메뉴입니다.");				
				break;
			}
		...
		case 70:
			if (temp == 2) {
				...
				System.out.print(" 흑당버블밀크티라떼는 없는 메뉴입니다.");				
				break;
			}
		...
		case 71:
			if (temp == 2) {
				...
				System.out.print(" 흑당버블그린티라떼는 없는 메뉴입니다.");	
				break;
			}
		...
		case 72:
			if (temp == 2) {
				...
				System.out.print(" 흑당라떼는 없는 메뉴입니다.");				
				break;
			}
		...
		default:
			if (temp == 2) {
				...
				System.out.print(" 흑당밀크티라떼는 없는 메뉴입니다.");				
				break;
			}
		}

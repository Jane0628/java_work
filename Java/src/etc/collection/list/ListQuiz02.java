...
//		User hong = new User("홍길동", 35);
//		User park = new User("박영희", 29);
//		User yoo = new User("유비", 62);
		
		Collections.addAll(users, new User("홍길동", 35), new User("박영희", 29)
				, new User("유비", 62));
...
//			System.out.printf("이름 : %s, 나이 : %d세\n", a.getName(), a.getAge());
		...
		/*
		 ...
		 - 향상 for문은 반복문을 시작할 때 구조적으로 컬렉션의 크기 및 사용 가능한 요소들의 개수를 항상 파악하고 있기 때문에

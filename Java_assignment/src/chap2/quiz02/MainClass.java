...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		Car c = new Car("Volvo S90");	//Main 메서드에서 Car 객체를 적절한 모델명과 함께 생성합니다.
		c.setSpeed(20);					//시동을 걸지 않은 상태에서 속도를 올려 봅니다.
		c.engineStart();				//그 후 시동을 걸고
		c.setMode('D');					//변속기를 D 모드로 지정한 후
		c.setSpeed(100);				//속도를 100까지 올립니다.
		c.engineStop();					//속도가 100인 상태에서 시동을 한 번 꺼 봅니다.
		c.setSpeed(0);					//속도를 완전히 줄인 후
		c.setMode('P');					//변속기를 P 모드로 지정하고
		c.engineStop();					//시동을 끕니다.
